...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ConvertRGBtoHex);
...
/* harmony import */ var _rgbtohex__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./rgbtohex */ "./src/rgbtohex.js");
...
window.addEventListener('load', () => {
    ...
    if(contColor) {
        ...
        const hexColor = (0,_rgbtohex__WEBPACK_IMPORTED_MODULE_2__["default"])(Number(colorArr[1]), Number(colorArr[2]), Number(colorArr[3]));
    ...
    for(let i=0; i<_task__WEBPACK_IMPORTED_MODULE_1__.app.getNumOfProjs(); i++){
        _task__WEBPACK_IMPORTED_MODULE_1__.app.getTasksWithinProj(_task__WEBPACK_IMPORTED_MODULE_1__.app.getProjects()[i]).forEach(task => {
            if((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(
                new Date(),
                (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(task.date)
                )){
                _createdom__WEBPACK_IMPORTED_MODULE_0__["default"].task(_task__WEBPACK_IMPORTED_MODULE_1__.app.getProjects()[i], task);
            }
        });
...
weekTasksBtn.addEventListener('click', () => {
    ...
    for(let i=0; i<_task__WEBPACK_IMPORTED_MODULE_1__.app.getNumOfProjs(); i++){
        _task__WEBPACK_IMPORTED_MODULE_1__.app.getTasksWithinProj(_task__WEBPACK_IMPORTED_MODULE_1__.app.getProjects()[i]).forEach(task => {
            if((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(
                new Date(),
                (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(task.date)
                )){
                _createdom__WEBPACK_IMPORTED_MODULE_0__["default"].task(_task__WEBPACK_IMPORTED_MODULE_1__.app.getProjects()[i], task);
